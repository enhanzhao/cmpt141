...
def can_evolve(source, target, d):
    """
    checks if source pokemon can evolve intotarget pokemon according to given dictionary
    source is string, name of a pokemon
    target is a string, name of a pokemon
    returns boolean based on if source can evolve into target in dictionary"""
    if source == target:
        return True
    if source in d:
        for i in d[source]:
            if can_evolve(i, target, d) is True:
                return True
    return False
...
print(can_evolve("bulbasaur", "venusaur", book1))
print("Using book1, can charmeleon evolve to blastoise?")
print(can_evolve("charmeleon", "blastoise", book1))
print("Using book2, can eevee evolve to articuno?")
print(can_evolve("eevee", "articuno", book2))
print("Using book3, can cubone evolve to charizard?")
print(can_evolve("cubone", "charizard", book3,))
print("Using book3, can magikarp evolve to mewtwo?")
print(can_evolve("magikarp", "mewtwo", book3))
